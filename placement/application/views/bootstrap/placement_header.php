...
<link href="<?php echo base_url();?>css/style_placement.min.css" rel="stylesheet" type='text/css'>
<link href="<?php echo base_url();?>css/style_body_override.min.css" rel="stylesheet" type='text/css'>
<?php
